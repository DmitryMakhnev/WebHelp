        ...
        >
          ...
          renderItem={representation => (
            <TableOfContentsListItem
              ...
              showSubPages={() => (tree as TableOfContentsTree).showSubPages(representation)}
              toggleSubPages={() => (tree as TableOfContentsTree).toggleSubPages(representation)}
              selectPage={() => (tree as TableOfContentsTree).selectPage(representation.id, true)}
              selectAnchor={(tree as TableOfContentsTree).selectAnchor}
            />
          )}
